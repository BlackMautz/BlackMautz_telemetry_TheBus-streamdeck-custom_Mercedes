# The Bus - Stream Deck Telemetry Plugin (BlackMautz Custom Edition - MERCEDES)

Ein **angepasstes Stream Deck Plugin** für die Steuerung von **The Bus** Simulatoren über die TML Studios Telemetry API.

**🚍 MERCEDES VERSION** - Speziell für Mercedes Citaro Busse

## 📋 Übersicht

Dieses Plugin ist eine **erweiterte Custom Edition** mit zusätzlichen Features und Verbesserungen, **100% optimiert für Mercedes Citaro** Busse.

**🚍 NUR FÜR MERCEDES CITARO BUSSE**
- ✅ **Mercedes Citaro** - Vollständig getestet und kompatibel
- ❌ **Andere Busmodelle** - NICHT KOMPATIBEL (z.B. SCANIA, Solaris, MAN)
...
- **Repository**: https://github.com/BlackMautz/BlackMautz_telemetry_TheBus-streamdeck-custom_Mercedes
...
- ✅ **Door Clearance** - Dynamische Icons (door_auto.png / door_auto_open.png)
- ✅ **Door Autoclose** - Dynamische Icons (kinderwagen.png / kinderwagen_on.png)
- ✅ **Auto Kneeling** - Dynamische Icons (auto_kneeling.png / auto_kneeling_on.png)
- ✅ **Interior Light Left** - Dynamische Icons (indoor-light_1L.png / indoor-light-on_1L.png)
- ✅ **Interior Light Right** - Dynamische Icons (indoor-light_1R.png / indoor-light-on_1R.png)
- ✅ **Driver Light** - Dynamische Icons (driver_light.png / driver_light_on.png)
- ✅ **Automatische Verbindung** - Verbindet automatisch mit 127.0.0.1:37337
...
## 📝 Version 1.0.0 Changelog (28.11.2025)

### 🎉 Erste Release - Mercedes Citaro Edition
- ✅ Alle Features der Solaris Edition v1.7.0 übernommen
- ✅ Angepasst für Mercedes Citaro Busse
- ✅ **LED Monitor** - 63 LEDs zur Überwachung aller Bus-Systeme
- ✅ **Passengers Button** - 7 Dropdown-Optionen für Passagier-Infos
- ✅ **Engine Info Button** - 8 Dropdown-Optionen für Motor-Daten
- ✅ **Speed Display** - Dynamisches Icon basierend auf Tempolimit
- ✅ **Fuel Display** - Live Kraftstoff-Anzeige mit Warnung
- ✅ **Climate Control** - 10 Optionen für Klimasteuerung
- ✅ **Light Control** - 12 Modi inkl. Interior Light Left/Right, Driver Light
- ✅ **Door Clearance** - Dynamische Icons
- ✅ **Door Autoclose** - Dynamische Icons
- ✅ **Auto Kneeling** - Dynamische Icons
- ✅ **Window Control** - Icons für Fahrerfenster
- ✅ **USB Clearance** - Dynamische Icons
- ✅ **Wheelchair Request** - Dynamische Icons
- ✅ Alle Action-Icons korrekt im Stream Deck angezeigt
- ✅ TML Studios Telemetry API Integration (127.0.0.1:37337)

---

## 📝 Solaris Edition Changelog History

### ✨ Manifest Icon Updates
- ✅ **Universal Button** - Icon aktualisiert von Icon_Custom zu Icon_Button_Off
- ✅ **Wiper Up** - Icon aktualisiert von Icon_Custom zu wiper
- ✅ **Wiper Down** - Icon aktualisiert von Icon_Custom zu wiper
- ✅ **Stop Brake** - Icon aktualisiert von Icon_Custom zu HaltestelleBremse
- ✅ **Kneeling/Lifting Control** - Icon aktualisiert von Icon_Custom zu kneeling
- ✅ **Climate Control** - Icon aktualisiert von Icon_Custom zu sonderzeichen18
- ✅ **Window Control** - Icon aktualisiert von Icon_Custom zu window-left-up
- ✅ **USB Clearance** - Icon aktualisiert von Icon_Custom zu USB
- ✅ **Wheelchair Request** - Icon aktualisiert von Icon_Custom zu Haltestelle_wheelchair

### 🎨 Verbesserungen
- Bessere Übersicht in der Stream Deck Action-Liste
- Alle Actions zeigen jetzt ihre korrekten Icons statt des Standard-Schraubenschlüssels
- Erleichtert das Auffinden der richtigen Aktionen beim Einrichten des Stream Decks

## 📝 Version 1.6.0 Changelog (28.11.2025)

### Neue Features:
- ✅ **Driver Light** - Dynamische Icons für Fahrerlicht
  - Primary (Aus): `driver_light.png`
  - Secondary (An): `driver_light_on.png`

### Verbesserungen:
- ✅ Light Control unterstützt jetzt Driver Light mit Button State API

---

## 📝 Version 1.5.0 Changelog (28.11.2025)

### Neue Features:
- ✅ **Interior Light Left** - Dynamische Icons für linke Innenbeleuchtung
  - Primary (Aus): `indoor-light_1L.png`
  - Secondary (An): `indoor-light-on_1L.png`
  
- ✅ **Interior Light Right** - Dynamische Icons für rechte Innenbeleuchtung
  - Primary (Aus): `indoor-light_1R.png`
  - Secondary (An): `indoor-light-on_1R.png`

### Verbesserungen:
- ✅ Light Control unterstützt jetzt 6 verschiedene Interior Light Modi
- ✅ Alle Interior Light Varianten nutzen Button State API

---

## 📝 Version 1.4.0 Changelog (28.11.2025)

### Neue Features:
- ✅ **Interior Light Dim** - Dynamische Icons mit 30% Helligkeit
  - Primary (Aus): `indoor-light_30pct.png`
  - Secondary (An): `indoor-light-on_30pct.png`
  
- ✅ **Interior Light Full** - Dynamische Icons mit 100% Helligkeit
  - Primary (Aus): `indoor-light_100pct.png`
  - Secondary (An): `indoor-light-on_100pct.png`

### Verbesserungen:
- ✅ Light Control unterstützt jetzt Button-basierte Lichter zusätzlich zu LED-basierten
- ✅ Interior Light Dim und Full arbeiten als Toggle-Gruppe

### Bekannte Einschränkungen:
- Interior Light Dim/Full Icons zeigen den Button-State, nicht den Master ON/OFF State

---

## 📝 Version 1.3.0 Changelog (28.11.2025)

### Neue Features:
- ✅ **Door Clearance** - Umgestellt auf dynamische Icons (Button State-basiert)
  - Primary (Aus): `door_auto.png`
  - Secondary (An): `door_auto_open.png`
  
- ✅ **Door Autoclose** - Umgestellt auf dynamische Icons (Button State-basiert)
  - Primary (Aus): `kinderwagen.png`
  - Secondary (An): `kinderwagen_on.png`
  
- ✅ **Auto Kneeling** - Jetzt mit dynamischen Icons (Button State-basiert)
  - Primary (Aus): `auto_kneeling.png`
  - Secondary (An): `auto_kneeling_on.png`
  
- ✅ **Automatische Verbindung** - Plugin verbindet sich automatisch mit 127.0.0.1:37337
  - Keine manuelle Konfiguration mehr nötig
  - Connection Status zeigt automatisch die Verbindung an

### Verbesserungen:
- ✅ Alle Button-basierten Status-Anzeigen nutzen jetzt UpdateButtonState statt UpdateButtonIcon
- ✅ Konsistentere Icon-Namen für bessere Wartbarkeit
- ✅ Verbesserte Status-Erkennung für Türfunktionen

### Bug-Fixes:
- ✅ Connection Status funktioniert wieder korrekt nach UUID-Änderungen
- ✅ Port korrigiert von 37737 auf 37337 (TheBus Standard-Port)
- ✅ Icon-Pfade korrigiert für Door Clearance und Door Autoclose
